meta:
  id: mediatek_lte_dsp_firmware_v2
  endian: le
  title: MediaTek LTE modem DSP firmware (new version)
  license: CC0-1.0
  application: Firmware image LTE modem DSP
doc: Firmware image for the Coresonic DSP found in newer MediaTek LTE modems.
seq:
  - id: header
    type: new_header
    size: 0x200
  ...
  new_dsp_firmware:
    seq:
      ...
      - id: section_headers
        ...
        size: 0x40
        repeat: expr
        repeat-expr: dsp_header.section_count
      - id: body
        size: dsp_header.unk3 - 0x200
      - id: dsp_firmware_header
        type: dsp_firmware_header
  dsp_header:
    seq:
      - id: magic
        contents: "DSP!"
      - id: ver
        type: u4
        doc: "I assume this is \"ver\" because that's how MediaTek usually does things."
      - id: unk0
        type: u4
      - id: len
        type: u4
